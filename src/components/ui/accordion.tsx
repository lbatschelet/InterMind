...
import { UIComponentWithClassNameProps } from '~/src/types/ui';

interface AccordionProps extends UIComponentWithClassNameProps {
...
interface AccordionItemProps extends UIComponentWithClassNameProps {
    value: string;
}

interface AccordionTriggerProps extends UIComponentWithClassNameProps {
    value: string;
}

interface AccordionContentProps extends UIComponentWithClassNameProps {
    value: string;
}
