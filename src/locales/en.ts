export default {
  ...
  thankyou: {
    title: "Thank You!",
    message: "Thank you for participating in our study! All survey periods have been completed. We appreciate your valuable contributions to our research."
  },
  permissions: {
  ...
  errors: {
    ...
    contentLoadFailed: "Failed to load content from the server. Please try again later."
  },
  consent: {
    title: "Consent",
    content: ""
